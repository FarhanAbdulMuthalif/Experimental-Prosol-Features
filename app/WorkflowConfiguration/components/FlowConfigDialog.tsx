            ...
            <section className="form-setuo-dialog-tab-onworkflow">
              ...
              {/* <div className="input-wrapper-div">
                ...
                <FormGroup
                  ...
                  style={{
                    boxShadow:
                      " 1px 1px 1px rgba(74, 74, 234, 0.159), -2px -2px 1px #ffffff",
                    border: " 1px solid rgba(74, 74, 234, 0.1)",
                    borderRadius: "5px",
                    padding: "0 15px",
                    display: "flex",
                    gap: "5px",
                  ...
                  row
                >
                  {formHeadFields.map((data: PostCreateFieldData) => {
                    return (
                      <FormControlLabel
                        ...
                        style={{
                          boxShadow:
                            " 2px 2px 2px rgba(74, 74, 234, 0.159), -2px -2px 2px #ffffff",
                          border: " 1px solid rgba(74, 74, 234, 0.2)",
                          borderRadius: "5px",
                          padding: "0 5px 0 0",
                        }}
                        labelPlacement="end"
